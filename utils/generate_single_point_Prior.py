...
# The original code is associated with the paper:
#   "Monte Carlo Linear Clustering with Single-Point Supervision is Enough for Infrared Small Target Detection", ICCV 2023.
...
if __name__ == "__main__":
    ...
    original_mask_dir = dataset_root + '/' + dataset + '/' + 'labels'
    txt_dir           = dataset_root + '/' + dataset + '/' + 'mode/' + 'train.txt'

    save_dir  = dataset_root + '/' + dataset + '/' + 'image_info_centroid/'
    img_id    = []
    range_min = 0
    range_max = 0
